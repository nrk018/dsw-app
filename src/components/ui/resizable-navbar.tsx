    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "none",
        width: visible ? "60%" : "calc(100% - 4rem)",
        y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
      ...
      className={cn(
        "relative z-[60] hidden flex-row items-center justify-between self-start rounded-full bg-transparent px-4 py-2 lg:flex dark:bg-transparent",
